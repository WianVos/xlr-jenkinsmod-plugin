...
def buildQueryString(params):
    ...
    if enc_key1 != None && enc_param1 != None:
        queryParams.append(enc_key1 + "=" + urllib.quote(enc_param1))

    if enc_key2 != None && enc_param2 != None:
        queryParams.append(enc_key2 + "=" + urllib.quote(enc_param2))

    if enc_key3 != None && enc_param3 != None:
        queryParams.append(enc_key3 + "=" + urllib.quote(enc_param3))
